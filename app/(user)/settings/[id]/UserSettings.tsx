...
const UserSettings = ({ id }: SettingsProps) => {
  ...
  return (
    <Container bground>
      <div className="w-full flex flex-col justify-center items-center mx-auto lg:w-1/3 bg-white px-4 py-4 rounded-[4px]">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col">
          ...
          <FormSelect
            ...
            required
          />
          <FormButton label="Save changes" type="submit" dark className="my-6"  />
        </form>
        <hr className="w-full" />
        <>
          <Button
